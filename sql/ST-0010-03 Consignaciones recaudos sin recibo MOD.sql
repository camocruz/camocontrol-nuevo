SELECT f0010_id_recaudo as id_recaudo,
       to_char(f0010_fecha_identificado, 'YYYY-MM-DD HH12:MI AM') as fecha_identificado,
...
where f0010_id_cia = '$001$'
       and f0010_recibo = 'N' and f0010_cliente_identificado <> '' order by f0010_id_recaudo