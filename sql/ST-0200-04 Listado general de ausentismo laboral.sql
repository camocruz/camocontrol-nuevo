SELECT f0216_id_ausentismo as id,
  ...
  left join camocontrol.tb0200_terceros as tb_ausente
  ...
  where f0216_id_cia = '00000001' and f0216_anulado = 'N'
        and f0216_fecha_inicio_tnl BETWEEN '2015-07-01' AND '2019-08-08' 
