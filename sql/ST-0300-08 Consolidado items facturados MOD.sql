...
SELECT f0307_id_factura_compras as id_fcc, f0307_numero_factura as fac_num, to_char(f0307_fecha_factura, 'YYYY-MM-DD') as fecha_factura, 
       ...
       f0305_id_accion as id_acc, coalesce(f0600_id_accion_principal,f0305_id_accion) as acc_raiz,
       ...
       f0305_docto_mov_inventario as id_doc_inv, coalesce(planta,tb_estructura_general.f0100_nombre) as planta
