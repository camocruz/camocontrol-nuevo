...
select f0800_id_despacho as id_pdd,
       ...
       to_char(f0800_fecha_cotizacion, 'YYYY-MM-DD HH12:MI AM') as fecha_pedido,
       f0800_g_reclamacion as reclamo, f0800_g_devolucion as devolucion
...
where f0800_anulado = 'N'
    and f0800_facturado = 'S' and f0800_revisado = 'N' and f0800_negado = 'N'
