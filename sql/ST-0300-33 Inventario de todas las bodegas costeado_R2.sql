...
from camocontrol.tb0309_items_movimientos 
   ...
   left join camocontrol.tb0307_facturas_compras
     on f0307_id_factura_compras = f0300_id_ultima_factura and f0309_id_item = f0300_id_item
where f0309_anulado = 'N' and f0309_id_cia = '00000001' and f0309_fecha_movimiento <= '2022-11-27'
group by f0309_id_item, item, f0300_ultimo_costo, f0300_costo_promedio,
         f0302_descripcion_tipo_item, f0002_unidad_medicion,
         f0005_descripcion_bodega, f0005_cod_bodega, f0307_fecha_factura
order by item