...
(
   select f0600_id_accion as id_acc,
	   ...
	   tb0607_seg_acc_personal.f0607_id_tercero AS tercero,
       ...
       f0606_fecha_inicio::date as dia,
   ...
   where f0606_tipo_nota = 'ACC' and f0600_id_cia = '00000001' and f0600_id_tipo_registro = '03' and f0600_anulado = 'N' 
       and f0606_fecha_fin BETWEEN '2021-07-01' AND '2021-07-31' 
...
select seguimientos_acciones.*, minfecha, maxfecha, h from seguimientos_acciones
   left join seguimientos_reloj
      on tercero = f0200_id_tercero  and seguimientos_acciones.dia = seguimientos_reloj.dia
