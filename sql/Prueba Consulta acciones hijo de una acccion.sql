select f0600_id_accion, row_number() OVER() AS row_number,
       tb_indices.v_indice,
       f0600_path,
...
from camocontrol.tb0600_acciones
   ...
   left join camocontrol.tb0100_estructura_mantenimiento as maquina
    ...
    left join (select * from camocontrol.get_acciones(12840, '')) as tb_indices
       on f0600_id_accion = tb_indices.id_accion
where f0600_id_cia = '00000001' and f0600_anulado = 'N' 
    and substring(f0600_path from 1 for char_length('-12840-')) = '-12840-'
--order by v_indice --, path_completo, f0600_id_tipo_registro desc, f0600_fecha_inicio, f0600_id_accion