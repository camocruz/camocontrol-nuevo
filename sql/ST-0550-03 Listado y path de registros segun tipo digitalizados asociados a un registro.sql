with otb_edicion as (
     select f0501_codigo_documento, f0501_id_documento, 
        ...
        where f0501_id_cia = '00000001' and f0501_codigo_documento = 'FOR-109'
...
from camocontrol.tb0501_documentos
      ...
      join camocontrol.tb0502_documentos_ed on f0502_id_ed = otb_edicion.max_ed
      ...
      join camocontrol.tb0503_archivos_asociados on f0503_nombre_archivo = f0007_valor_variable || '-' || lpad(f0502_id_ed::text, 8, '0')
where f0503_id_cia = '00000001'
      and tb0501_documentos.f0501_codigo_documento = 'FOR-109'
