select f0402_id_rp as id_rp, f0402_turno as turno, f0402_clasificador as clasificador, f0402_id_item as id_item, f0300_referencia as ref_1, f0402_lote as lote,
  ...
  f0402_tree_path,
  f0402_costo_prod_semiterm,
  f0402_costo_prod_semiterm_np,
  f0402_costo_otros,
  f0402_costo_otros_np,
  f0402_costo_total,
...
where f0402_anulado = 'N' and f0402_id_cia = '00000001'
    and f0402_fecha_produccion BETWEEN '2018-01-01' and '2018-02-15'
order by f0402_tree_path desc