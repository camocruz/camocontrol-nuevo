...
FROM $df001$.tb0600_acciones
    ...
    join $df001$.tb0200_terceros as tb_emisor
    ...
    left join $df001$.tb0800_despachos_comercial
       on f0600_id_accion = f0800_id_accion
    left join $df001$.tb0200_terceros as tercero_ped
       on tercero_ped.f0200_id_tercero = f0800_cliente
    left join $df001$.tb0200_terceros as transportadora
       on transportadora.f0200_id_tercero = f0800_transportadora
    left join $df001$.tb0200_terceros as tercero_acc
    ...
    left join $df001$.tb0609_modos_efectos_falla as otb_mef
       on otb_mef.f0609_id_mef = f0600_id_mef
    left join $df001$.tb0609_modos_efectos_falla as otb_causa
