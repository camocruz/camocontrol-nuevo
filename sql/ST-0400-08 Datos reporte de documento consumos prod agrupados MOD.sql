SELECT 
 ...
 FROM $df001$.tb0310_documentos_movimientos_inventarios as otb_prim
    join 
(
...
from $df001$.tb0310_documentos_movimientos_inventarios as otb_movimiento
       join $df001$.tb0310_documentos_movimientos_inventarios as otb_ref
...
where otb_movimiento.f0310_id_documento='$002$'
...
order by item
 ...
 where otb_prim.f0310_id_cia = '$001$' and otb_prim.f0310_id_documento = '$002$'
 order by item
