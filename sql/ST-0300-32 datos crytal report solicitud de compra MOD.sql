select f0305_id_solicitud_compra as id_solicitud, f0305_id_accion as id_accion,
       ...
       || COALESCE(otb_estructura_madre.f0100_codigo || ' -- { ' || otb_estructura_madre.f0100_nombre || ' }',
                    coalesce(otb_estructura_referida.f0100_codigo || ' -- { ' || otb_estructura_referida.f0100_nombre || ' }'),'')
       || ' <=> Inv_tot: ' || f0305_inventario  as descripcion,
...
from $df001$.tb0305_items_solicitados
    ...
    join $df001$.tb0200_terceros as tb_solicitado
...
Where f0305_id_solicitud_compra = '$001$' and f0305_anulado = 'N'