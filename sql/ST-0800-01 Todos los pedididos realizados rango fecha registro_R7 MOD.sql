select f0800_id_despacho as id_pdd, coalesce(f0005_cod_bodega, 'ND') as bodega,
	  ...
	  f0800_guia_transportadora as guia, to_char(f0800_fecha_registro_guia_transp, 'YYYY-MM-DD HH12:MI AM') as fecha_guia,
...
from $df001$.tb0800_despachos_comercial
     ...
     left join $df001$.tb0200_terceros as tb_cliente
	 ...
	 left join $df001$.tb0803_causas_demoras_despachos
	 ...
	 left join $df001$.tb0611_mef_sub_fuentes_acc
