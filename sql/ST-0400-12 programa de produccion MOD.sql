...
FROM $df001$.tb0401_items_prog_prod
    ...
    left join $df001$.tb0350_plantillas
      on f0401_id_item = f0350_id_item and f0350_activa = 'S'
where f0401_anulado = 'N' and f0401_id_cia = '$001$'
      --and array_length(string_to_array(f0401_tree_path, '-'),1)=4 
      and (f0401_fecha_inicio BETWEEN '$002$' AND '$003$' or
           f0401_fecha_final BETWEEN '$002$' AND '$003$')
