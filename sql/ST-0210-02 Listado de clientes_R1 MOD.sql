SELECT f0200_id_tercero as id_tercero, 
  ...
  FROM $df001$.tb0200_terceros
  	 JOIN $df001$.tb0052_ciudades ON f0200_ciudad_residencia = tb0052_ciudades.f0052_codigo_ciudad
     JOIN $df001$.tb0051_departamentos ON tb0051_departamentos.f0051_codigo_departamento = tb0052_ciudades.f0052_codigo_departamento
 where f0200_id_cia = '$001$' and f0200_ind_cliente = 'S'
