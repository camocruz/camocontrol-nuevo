select f0309_id_item as id_item, f0300_referencia as referencia, f0300_codigo_cguno as codigo_cg,
...
where f0309_id_bodega = '$002$' and f0309_anulado = 'N' and f0309_id_cia = '$001$'
