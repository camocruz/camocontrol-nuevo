...
from $df001$.tb0309_items_movimientos
    join $df001$.tb0305_items_solicitados
	  on f0305_id_item_solicitud = f0309_id_item_solicitud
    join $df001$.tb0300_items on f0305_id_item = f0300_id_item 
	join $df001$.tb0002_unidades_medicion on f0300_id_unidad_medicion = f0002_id_unidad_medicion 
	join $df001$.tb0304_solicitud_compra on f0305_id_solicitud_compra = f0304_id_solicitud 
	left join $df001$.tb0100_estructura_mantenimiento as otb_estructura_referida 
	   on f0305_id_estructura = otb_estructura_referida.f0100_id_estructura 
	left join $df001$.tb0100_estructura_mantenimiento as otb_estructura_madre 
	...
	left join $df001$ .tb0600_acciones on f0305_id_accion = f0600_id_accion 
where f0309_id_factura_costo = '$001$' AND f0309_anulado = 'N'
