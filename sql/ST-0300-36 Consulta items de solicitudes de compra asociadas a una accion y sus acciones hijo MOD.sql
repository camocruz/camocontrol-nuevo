...
Where (f0600_id_cia = '$001$' and f0600_id_accion = '$002$' and f0305_anulado = 'N') 
        or 
      (f0600_id_cia = '$001$' and substring(f0600_path from 1 for char_length('$003$')) = '$003$'  and f0305_anulado = 'N')
