SELECT f0402_id_rp as id_rp,
  ...
  FROM camocontrol.tb0402_reporte_produccion
     left join camocontrol.tb0300_items on f0402_id_item = f0300_id_item
     left join camocontrol.tb0002_unidades_medicion on f0300_id_unidad_medicion=f0002_id_unidad_medicion
     left join camocontrol.tb0014_centros_operacionales on f0014_co_cg = f0402_co_cguno and f0402_id_cia = f0014_id_cia
  where f0402_id_cia = '00000001'  
      and f0402_fecha_produccion BETWEEN '2018-01-01' and '2019-07-31' 
