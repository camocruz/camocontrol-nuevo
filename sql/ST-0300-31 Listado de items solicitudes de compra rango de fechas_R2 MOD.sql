select f0305_id_item_solicitud as id_sc_item, 
       ...
       case coalesce(tb_tercero_oc.f0200_id_tercero, '0')
		  when '0' then trim( both ' ' from coalesce(tb_tercero_factura.f0200_apellido1 || ' ' || tb_tercero_factura.f0200_nombres, 'ND'))
          else
          trim( both ' ' from coalesce(tb_tercero_oc.f0200_apellido1 || ' ' || tb_tercero_oc.f0200_nombres, 'ND'))
       end as proveedor, 
	   ...
	   f0307_numero_factura as num_factura
from $df001$.tb0305_items_solicitados
   left join $df001$.tb0307_facturas_compras
      on f0307_id_factura_compras = f0305_id_factura_compras
   left join $df001$.tb0200_terceros as tb_tercero_factura
...
Where f0305_anulado = 'N' and f0305_id_cia = '$001$'
   and f0305_fr BETWEEN '$002$' and '$003$' 
