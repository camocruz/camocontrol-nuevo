...
Public Class MyCustomerInfoUserControl
    ...
    Public Sub InitializeComponent()
        ...
        Controls.AddRange(New System.Windows.Forms.Control() {labelName,
           labelAddress, labelCityStateProvincePostal, labelCountryRegion,
           labelEmail, textName, textAddress, textCity, textStateProvince,
    ...
    Private Sub textEmail_Validating(sender As Object,
    ...
    Private Sub textEmail_Validated(sender As Object,
